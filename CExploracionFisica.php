...
<form name="form" action="CExploracionFisica.php" method="POST" onsubmit="">
...
<center><h3>Exploracion Fisica</h3></center>
...
<tr>
	...
	<th bgcolor="black"><font color="white">Peso</font></th> <th bgcolor="black"><font color="white">Talla</font></th> 
	<th bgcolor="black"><font color="white">Frecuencia Cardiaca</font></th> <th bgcolor="black"><font color="white">TA</font></th>
	<th bgcolor="black"><font color="white">OD</font></th> <th bgcolor="black"><font color="white">OJ</font></th>
	<th bgcolor="black"><font color="white">Dientes</font></th> <th bgcolor="black"><font color="white">Caries</font></th>
	<th bgcolor="black"><font color="white">Sopos</font></th> <th bgcolor="black"><font color="white">Tipo Localizacion</font></th>
	<th bgcolor="black"><font color="white">Area Pulmonal</font></th> <th bgcolor="black"><font color="white">Abdomen</font></th>
	<th bgcolor="black"><font color="white">Miembro</font></th> <th bgcolor="black"><font color="white">Observaciones</font></th>
	<th bgcolor="black"><font color="white">Electro Cardiograma</font></th> <th bgcolor="black"><font color="white">Ecocardiograma</font></th>
	<th bgcolor="black"><font color="white">Expirometria</font></th> <th bgcolor="black"><font color="white">Laboratorio</font></th>
	
	
</tr>
      <?php
        include "./php/Connexion.php";
        $sentecia="SELECT * FROM exploracionfisica";
		...
		<td><?php echo $fila['FrecuenciaCardiaca']; ?></td>
		<td><?php echo $fila['TA']; ?></td>
		<td><?php echo $fila['VisionOD']; ?></td>
		<td><?php echo $fila['VisionOJ']; ?></td>
		<td><?php echo $fila['DientesAusentes']; ?></td>
		<td><?php echo $fila['DientesCaries']; ?></td>
		<td><?php echo $fila['SoposCardiaca']; ?></td>
		<td><?php echo $fila['TipoLocalizacion']; ?></td>
		<td><?php echo $fila['AreaPulmonal']; ?></td>
		<td><?php echo $fila['Abdomen']; ?></td>
		<td><?php echo $fila['MiembroInferiores']; ?></td>
		<td><?php echo $fila['Observaciones']; ?></td>
		<td><?php echo $fila['ElectroCardiograma']; ?></td>
		<td><?php echo $fila['Ecocardiograma']; ?></td>
		<td><?php echo $fila['Expirometria']; ?></td>
		<td><?php echo $fila['AnalisisLaboratorio']; ?></td>
		<td><a href="MExploracionFisica.php?Id=<?php echo $fila['Id_Registro']; ?>" class="btn btn-warning">Editar</a></td>
...
if(isset($_POST['btnDelete']))
{
	if (empty($_POST['Eliminar']))
	{
		...
		{
			$Borrar = $Conexion->query("DELETE FROM exploracionfisica WHERE Id_Registro = '$Id_Borrar'");
			if ($Borrar)
			{
